...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        //this key lets our app talk to parse
        Parse.setApplicationId("JLGhoFfvWsY7Uz3Z6KHfEDnsFICzJZekpwbY9RNf", clientKey: "OaXZLbOJFiu3g5akrKRnD0JSX6E5FbFjFlZDxWE4")
        //like google analytics for parse
